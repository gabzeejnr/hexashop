...
export default function C({ img, title, sub, text }) {
    return (
        <div className="hi h-90 lg:h-auto relative text-background"> {/*  h-90 lg:h-60 xl:h-80 2xl:h-100 */}
            ...
            <div className="hero-hover transition-all duration-500 absolute hidden z-1 text-center bg-[#0000006c] h-full w-full p-5 flex-col items-center justify-center gap-4">
